...
const Notifications = () => {
    ...
    let { userAuth, userAuth: { access_token, new_notification_availiable }, setUserAuth} = useContext(UserContext)
    ...
    const fetchNotifications = ({ page, deletedDocCount = 0 }) => {
        ...
        .then( async ({ data: { notifications: data }}) => {
            ...
            if( new_notification_availiable ){
                setUserAuth({ ...userAuth, new_notification_availiable: false})
            }
        ...
        <div>
...

            {
                ...
                <>
                {
                    ...
                    : <NoDataMessage message="nothing yet" />
                }
