...
const ManageBlogs = () => {
    ...
    }, [access_token, blogs, drafts, query] ) //blogs, make it indefinate
        ...
        <>
            ...
            <InPageNavigation routes={["Published Blogs", "Drafts"]} defaultActiveIndex={ activeTab != 'draft' ?  0 : 1 }>
                ...
                {//draft one
                    ...
                    <>
                        {
                            drafts.results.map((blog, i) => {
                                return <AnimationWrapper key= {i} transition = {{ delay : i * 0.04}} >
                                    ...
                                    <ManageDraftBlogPost blog={{ ...blog, index: i+1, setStateFun: setDrafts}} />
                                </AnimationWrapper>
                            })
                        }
                    ...
                    : <NoDataMessage message = "No Drafts Blog" />
                }
