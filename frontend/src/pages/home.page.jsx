...
const HomePage = () => {
    ...
    let categories = ["Tech", "Language", "Social Media", "Placements", "Computers", "Binary", "Blog 6"]
                            ...
                            <div className="flex gap-3 flex-wrap">
                                {
                                    categories.map((category, i) => {
                                        return <button onClick={loadBlogById} className={" tag " + ( pageState == category.toLowerCase() ? " bg-black text-white " : " ")} key={i} >
                                            {category}
                                        </button>
                                    })
                                }
