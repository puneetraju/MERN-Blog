...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        let { bio, username, youtube, facebook, twitter, github, instagram, website} = formData;
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/update-profile",{
            username, bio, social_links: { youtube, facebook, github, instagram, twitter, website}
        }, {
            headers: {
                'Authorization':`Bearer ${access_token}`
            }
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-dark-grey -mt-3">Username is used to search the user, and is visible to everyone </p>
