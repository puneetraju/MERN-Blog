...
// console.log(access_token);
   ...
   const handleSubmit = (e) =>{
     ...
     if(!passwordRegex.test(password)){
         return toast.error("Password should contain 6 - 20 letters including atleast 1 uppercase, 1 lowercase, 1 number")
     }
   ...
   const handleGoogleAuth = (e) => {
      ...
      .catch(err => {
         toast.error('Trouble in google authentication');
