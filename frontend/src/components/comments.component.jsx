...
const CommentsContainer = () => {
    ...
    return(
        ...
        className={
          "max-sm:w-full fixed " +
          (commentsWrapper
            ? " sm:top-0 sm:right-0 max-sm:right-0"
            : " sm:top-[100%] sm:right-[-100%] max-sm:right-[-100%]") +
          " duration-700 max-sm:transition-right sm:transition-all w-[30%] min-w-[350px] h-full z-50 bg-white shadow-2xl p-8 px-16 overflow-y-auto overflow-x-hidden"
        }
      >
        <div className="relative">
          ...
          <button
            ...
            className="absolute top-0 right-0 flex justify-center items-center h-12 w-12 rounded-full bg-grey"
          >
            <i className="fi fi-br-cross text-2xl mt-1 leading-none"></i>
          </button>
        </div>
