...
const PublishForm = () => {
    ...
    const handleTagKeyDown = (e) => {
        if(e.keyCode == 13 || e.keyCode == 188){
            ...
            if(tags.length < tagLimit){
                ...
                toast.error(`At most, ${tagLimit} tags can be added.`)
            }
    ...
    const publishBlog = (e) => {
        ...
        if(!des.length || des.length > characterLimit){
            return toast.error(`Write a description under ${characterLimit} to publish`)
        }
        if(!tags.length){
            return toast.error("Submit atleast single tag to publish")
        }
    ...
    return (
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <button className = "h-12 w-12 absolute right-[5vw] z-10 top-[5%] lg:top-[10%]"
                onClick={handleCloseEvent}
                >
                <i className="fi fi-br-cross"></i>
                </button>

                 <div className="max-w-[500px] block ">   {/* center instead of block*/}
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <div className="relative input-box pl-2 py-2 pb-4">
                        ...
                        <input type="text" placeholder = "Topics for the blog..." className="sticky input-box bg-white top-0 left-0 pl-4 mb-3 focus:bg-white " 
                    ...
                    <p className="mt-1 mb-4 text-dark-grey text-sm text-right">{tagLimit - tags.length}/{tagLimit} tags left</p>
