        ...
        <div className="flex gap-2 max-lg:mb-6 max-lg:pb-6 border-grey max-lg:border-b">
            {
                Object.keys(stats).map((key, i) => {
                    ...
                    <div key={i} className={"flex flex-col items-center h-full w-full justify-center p-4 px-6 " + (i != 0 ? "border-grey border-l" : "")}>
    ...
    return(
        <>
            <div className="flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center ">
                ...
                <img src={banner} className="max-md:hidden lg:hidden xl:block w-28 h-28 rounded-full  flex-none bg-grey object-cover"/>
                ...
                <div className="flex flex-col justify-between py-2 w-full min-w-[300px]">
                    ...
                    <div className="flex gap-6 mt-3">
                        ...
                        <button className="py-2 pr-4 underline text-red"
                        onClick={(e)=> deleteBlog(blog, access_token, e.target )}>Delete</button>
 ...
 index++;
    ...
    return (
        <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
            ...
            <h1 className="blog-index text-center pi-4 md:pl-6 flex-none">{index < 10 ? "0" + index : index}</h1>
