...
const BlogPostCard = ({content , author}) => {
    ...
    let { publishedAt, title, des, banner, tags, activity:{ total_likes }, blog_id: id} = content;
    ...
    return (
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
            <div className= "w-full">
                ...
                <p className="my-3 text-xl font-gelasio leading-7 hidden min-[1100px]:block line-clamp-2">{des}</p>
