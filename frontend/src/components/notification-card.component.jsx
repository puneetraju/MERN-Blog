        ...
        <div className={"p-6 border-b border-grey border-l-black " + (!seen ? "border-l-2" : "")}>
...

            {
                isReplying ? <div className="mt-8">
                    <NotificationCommentField _id={_id} blog_author={user} index={index} replyingTo={comment._id} setReplying={setReplying} notification_id={notification_id} notificatonData={notificationState} />
                </div>
                : ""
            }

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    ...
                    <p className="ml-14 my-2 font-gelasio text-xl ">{reply.comment}</p>
